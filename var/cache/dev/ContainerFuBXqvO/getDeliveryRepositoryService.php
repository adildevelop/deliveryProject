...
class getDeliveryRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/DeliveryRepository.php';

        return $container->privates['App\\Repository\\DeliveryRepository'] = new \App\Repository\DeliveryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
