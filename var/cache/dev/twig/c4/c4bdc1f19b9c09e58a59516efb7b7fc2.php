...
class __TwigTemplate_9febcedf9520a4ab04a5d618c6dbdf38 extends Template
{
    private $source;
    private $macros = [];
...
{% for css_asset in assets %}
    ...
    {% endif %}
{% endfor %}
", "@EasyAdmin/includes/_css_assets.html.twig", "/var/www/delivery-app/vendor/easycorp/easyadmin-bundle/src/Resources/views/includes/_css_assets.html.twig");
    }
}
